...
export default function Footer() {
  ...
  useEffect(() => onSettingsChange(s => setSocialLinks(s.socialLinks)), [])
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                ...
                <span className="text-sm">91 Springboard, Sector 1, Noida, Uttar Pradesh 201301</span>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm">support@rstate.in</span>
              </div>
            </div>
          </div>
        </div>
