...
export default function BuyerDashboard() {
  ...
  const stats = [
    { icon: HiHeart, label: 'Saved Properties', value: savedIds.length, color: 'text-red-500', bg: 'bg-red-50 dark:bg-red-900/20' },
    { icon: HiEye, label: 'Viewed Properties', value: viewedIds.length, color: 'text-blue-500', bg: 'bg-blue-50 dark:bg-blue-900/20' },
    { icon: HiCalendar, label: 'Visit Scheduled', value: visitCount, color: 'text-green-500', bg: 'bg-green-50 dark:bg-green-900/20' },
    { icon: HiChat, label: 'Active Chats', value: 0, color: 'text-purple-500', bg: 'bg-purple-50 dark:bg-purple-900/20' },
  ]
